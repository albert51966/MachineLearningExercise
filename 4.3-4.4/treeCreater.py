'''
X需要为pd.DataFrame数据类型；y需要为pd.Series类型
'''
...
if __name__ == '__main__':
    ...
    # 4.3
    data_path = r'H:\MachineLearningTraining\MachineLearning\4.3-4.4\watermelon3_0_Ch.csv'
    ...
    # 4.4
    data_path2 = r'H:\MachineLearningTraining\MachineLearning\4.3-4.4\watermelon3_0_Ch.csv'
