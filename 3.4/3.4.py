...
data_path = r'H:\MachineLearningTraining\MachineLearning\3.4\Transfusion.txt'
#数据地址：https://archive.ics.uci.edu/ml/datasets/Blood+Transfusion+Service+Center  (R F M T )
